        ...
        return (
            <form>
                <div class="form-group">
                    <input class="form-control form-control-lg mt-4" type="text" name="email" placeholder="Enter your mobile number"/>
                </div>
                <div class="form-group">
                    <input class="form-control form-control-lg mb-2" type="password" name="password" placeholder="Enter your password"/>
                    <Link to='/request/passoword/reset' className="sidebar-link">
                        <small>
                ...
                <a class="btn btn-lg btn-secondary" onClick={() => this.props.login()}>
                    <i class="fe fe-log-in mr-3"></i> Sign in
                </a>
                </div>
            </form>
        )
